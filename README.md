...
Ce référentiel regroupe toutes les ressources nécessaires au modèle de données PGA 13-BE pour les plans généraux d'approvisionnement en eau (PGA). Les ressources ont été élaborées dans le cadre du projet [PIE Plateforme d'information sur l'eau](https://www.ipw.sites.be.ch/de/start.html) et sont mises à disposition du public ici.
